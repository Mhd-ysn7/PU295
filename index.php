      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <p>Join our loyal customers who trust us for exceptional service and quality rentals.</p> 
        </div>
      </div>
    </div>
  </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Always <span>By Your Side</span></h2>
      <p>Book online hassle-free and embark on your next road trip with confidence.</p>
    </div>
    <div class="row"> 
