	...
	if (isset($_POST['submit'])) {
		try {
			...
			$query->bindParam(':vehicletitle', $_POST['vehicletitle'], PDO::PARAM_STR);
			$query->bindParam(':brand', $_POST['brandname'], PDO::PARAM_STR);
			$query->bindParam(':vehicleoverview', $_POST['vehicalorcview'], PDO::PARAM_STR);
			$query->bindParam(':priceperday', $_POST['priceperday'], PDO::PARAM_STR);
			$query->bindParam(':fueltype', $_POST['fueltype'], PDO::PARAM_STR);
			$query->bindParam(':modelyear', $_POST['modelyear'], PDO::PARAM_STR);
			$query->bindParam(':seatingcapacity', $_POST['seatingcapacity'], PDO::PARAM_STR);
			$query->bindParam(':airconditioner', $_POST['airconditioner'], PDO::PARAM_STR);
			$query->bindParam(':powerdoorlocks', $_POST['powerdoorlocks'], PDO::PARAM_STR);
			$query->bindParam(':antilockbrakingsys', $_POST['antilockbrakingsys'], PDO::PARAM_STR);
			$query->bindParam(':brakeassist', $_POST['brakeassist'], PDO::PARAM_STR);
			$query->bindParam(':powersteering', $_POST['powersteering'], PDO::PARAM_STR);
			$query->bindParam(':driverairbag', $_POST['driverairbag'], PDO::PARAM_STR);
			$query->bindParam(':passengerairbag', $_POST['passengerairbag'], PDO::PARAM_STR);
			$query->bindParam(':powerwindow', $_POST['powerwindow'], PDO::PARAM_STR);
			$query->bindParam(':cdplayer', $_POST['cdplayer'], PDO::PARAM_STR);
			$query->bindParam(':centrallocking', $_POST['centrallocking'], PDO::PARAM_STR);
			$query->bindParam(':crashcensor', $_POST['crashcensor'], PDO::PARAM_STR);
			$query->bindParam(':leatherseats', $_POST['leatherseats'], PDO::PARAM_STR);
	...
	<select class="selectpicker" name="fueltype" required>
			<?php $fuelType = isset($_POST['fueltype']) ? $_POST['fueltype'] : $result->FuelType; ?>
